...
const { Car, Bike, DollarSign, Wrench, AlertCircle, Plus, Camera, FileText, Download, Upload, Trash2 } = await import('https://cdn.skypack.dev/lucide-react');
...
const VehicleManager = () => {
                ...
                React.createElement('div', { className: "space-y-2 text-sm" },
                  React.createElement('div', { className: "flex justify-between" },
                    React.createElement('span', { className: "text-gray-400" },
                      'TÜV:',
                      React.createElement('span', { className: "text-xs italic ml-1" }, 'Inspection')
                    ),
                    React.createElement('span', { className: tuvDays !== null && tuvDays < 30 ? 'text-red-400' : 'text-green-400' },
                      vehicle.tuv.date || React.createElement('span', {}, 'Nicht eingetragen ', React.createElement('span', { className: "italic text-xs" }, 'Not entered')),
                  ...
                  React.createElement('div', { className: "flex justify-between" },
                    React.createElement('span', { className: "text-gray-400" },
                      'Ölwechsel:',
                      React.createElement('span', { className: "text-xs italic ml-1" }, 'Oil Change')
                    ),
                  ...
                  React.createElement('div', { className: "flex justify-between" },
                    React.createElement('span', { className: "text-gray-400" },
                      'Gesamtkosten:',
                      React.createElement('span', { className: "text-xs italic ml-1" }, 'Total Cost')
                    ),
  ...
  return React.createElement('div', { className: "min-h-screen bg-gray-900 text-white p-6" },
    React.createElement('p', { className: "text-center text-gray-400 py-8" }, 'Detail view - Full implementation continues here...')
  );
};
